...
$plugin->version   = 2019032004;        // The current plugin version (Date: YYYYMMDDXX).
$plugin->release  = 'v3.7.0.0';
$plugin->maturity  = MATURITY_STABLE;
$plugin->requires  = 2017050500;        // Requires this Moodle version.
$plugin->component = 'local_createreassessmentmoodlegroup';  // Full name of the plugin (used for diagnostics).
